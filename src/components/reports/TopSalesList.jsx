                ...
                <div className={`bg-white w-full h-full shadow-lg rounded p-5 flex flex-col`}>
                    ...
                    <div className={`flex-1 flex flex-col space-y-4`}>
                        {topSalesList.map((data, index) => (
                            <div key={index} className={`border-b border-erp-gray flex flex-row justify-between items-center p-3`}>
                                <p className={`text-xl`}> {data.itemNm} </p>
                                <p className={`text-xl`}>{data.itemSales.toLocaleString()} 원</p>
                            </div>
                        ))}
                    </div>
                </div>
